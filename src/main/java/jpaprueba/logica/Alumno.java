...
public class Alumno implements Serializable {
    @Id // Annotation para la PRIMARY KEY
    @GeneratedValue(strategy=GenerationType.AUTO) // AUTOLLENADO MAS SU ESTRATEGIA DE AUTOLLENADO
    private int id;
    @Basic // Para campos simples (NO ES OBLIGATORIO)
    private String nombre;
    private String apellido;
    @Temporal(TemporalType.DATE) // Annotation para fecha
    private Date fechaNac;
    
    // Annotation para clave foranea 1 a 1
    @OneToOne 
